...
const Testimonials = () => {
  ...
  <div>
    <h2 className='text-blue-600 text-md text-center my-4 font-bold'>Students Love Us</h2>
    <h2 className='text-3xl text-center font-semibold my-4'>Student Testimonials</h2>
    <p className='text-xl text-gray-500 max-w-2xl my-4'>
  ...
  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-col-3 gap-4 mt-8 w-full mx-auto'>
    {/* Testimonials go here, use appropriate responsive classes */}
        <div className='flex flex-wrap  items-center gap-4  mt-8w-11/12 mx-auto '>
                         <div className='border-2 rounded-3xl  bg-gray-200  '>
                        <p className=' text-gray-500  text-xl m-8 py-12 '>If there’s one resource that Web3 developers point to, it’s Cyfrin’s ultimate tutorials. They’re standout resources that have empowered countless developers to learn blockchains, learn Solidity, and dive deep into Web3 development.</p>
                         <span className='flex items-center p-8 m-8 w-32 gap-2'>
                          <img src={chainlink} alt='avatar'  />
                          Chainlink
                          Chainlink
                      </span> 
