  ...
  return (
    <main>
        <div>
            ...
            <div className='flex  items-center gap-4 mt-8 mx-8 '>
            <div className='border-2 rounded-3xl bg-gray-200 w-full md:w-max'>
      ...
      <div className='flex flex-wrap  justify-center items-center gap-4 mt-8 mx-8 '>
