...
const Courses = () => {
  ...
  <div className=' mt-16 w-11/12  mx-auto rounded-3xl bg-gradient-to-br from-gray-300 via-gray-300 to-red-400 '>
    <div className='flex flex-col md:flex-col-1 items-center w-11/12 mx-auto'>
      ...
      <p className='mt-12 text-2xl text-gray-600 text-center mx-10'>Whether youre new to web3, a seasoned engineer, or an aspirant smart contract auditor, we have the right courses for you.</p>
    </div>
